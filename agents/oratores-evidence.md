...
- **Name what a hostile reader checks first, in order.** That is `checked_first`, and it is the cheapest work in your file. The claim they check first is the claim that decides whether the rest is read.
