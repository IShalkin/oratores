...
Write your file once, complete, at the end of your work — not incrementally. A half-written file is indistinguishable from a crashed agent's, and the panel may read the directory at any moment. Valid JSON, UTF-8, no trailing commas, no comments. Keep minted ids short and stable; other files refer to them.
